...
import { ArrowRight, UserCheck, Zap, Users, CheckCircle, GraduationCap } from "lucide-react";
        ...
        <section className="bg-gradient-to-b from-white to-swap-lightBlue/30 py-16 md:py-24">
          <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-swap-blue font-semibold text-lg">Built Exclusively for Exchange Students</span>
            </div>
            <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              We Handle Everything<br />
              <span className="text-swap-blue">So Exchange Students Don't Have To</span>
            </h1>
