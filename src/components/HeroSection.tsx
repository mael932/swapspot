    ...
    <section className="bg-gray-50 py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Button asChild variant="outline" size="lg" className="text-lg px-8 py-6 border-gray-300 text-gray-700 hover:bg-gray-100">
            <Link to="/how-it-works">See How We Work For Exchange Students</Link>
          </Button>
        </div>
        
        <div className="mt-12 bg-white/90 backdrop-blur-sm rounded-lg p-6 max-w-4xl mx-auto border border-gray-200 shadow-sm">
